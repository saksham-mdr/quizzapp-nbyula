      ...
      <div class="container px-6 py-4 mx-auto">
        <div class="lg:flex">
          <div class="w-full -mx-6 lg:w-2/5 	">
            <center>
              <div class="px-6 ">
                ...
                <div class="flex mt-4 -mx-2 place-content-center">
                  <a
                    href="#"
          ...
          <div class="mt-6 lg:mt-0 lg:flex-1">
            <div class="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-3">
              <div>
                <h3 class="text-gray-700 uppercase dark:text-white">Information</h3>
                <a
                  href="#"
        ...
        <div>
          <p class="text-center text-gray-800 dark:text-white">
            © FurnitureLand 2022 - All rights reserved
          </p>
        </div>
      </div>
    </footer>
